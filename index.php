    ...
    <header>
        <div class="relative">
            <div class="sliderBanner overflow-hidden">
                ...
                ?>
                    <img style="height: 1000px;" class="focus:outline-none" src="./assets/img/<?php echo $values['slide'] ?>" alt="">
                <?php } ?>
            </div>
                ...
                <div class="relative group">
                    <a class="" href="./product.php?id_tour=<?php echo $holi['id_tour'] ?>">
                        <div class="overflow-hidden rounded-md border border-white">
                            <img class="transition duration-300 transform group-hover:scale-105 w-full" src="./assets/img/<?php echo $holi['image_main'] ?>" alt="" style="height: 430px;width: 725px;">
                        </div>
            ...
            ?>
                <article class="mx-6 relative py-10 group focus:outline-none outline-none">
                    <a class="focus:outline-none" href="./product.php?id_tour=<?php echo $row['id_tour'] ?>">
                        <div class="overflow-hidden rounded-md border border-white">
                            <img class="transition duration-300 transform group-hover:scale-105" src="./assets/img/<?php echo $row['image_main'] ?>" width="461" style="height: 281px;" alt="">
                        </div>
                ...
                <div class="col-span-2 mt-2">
                    <div class="relative group mr-2 object-fill">
                        <a class="" href="./product.php?id_tour=<?php echo $rown['id_tour'] ?>">
                            <div class="overflow-hidden rounded-md border border-white">
                                <img class="transition duration-300 transform group-hover:scale-105 w-full object-cover" src="./assets/img/<?php echo $rown['image_main'] ?>" alt="">
                            </div>
                ...
                ?>
                    <article class="relative group m-2" style="width: 365px; height: 242px;">
                        <a class="" href="./product.php?id_tour=<?php echo $rownn['id_tour'] ?>">
                            <div class="overflow-hidden rounded-md border border-white">
                                <img class="transition duration-300 transform group-hover:scale-105 w-full" src="./assets/img/<?php echo $rownn['image_main'] ?>" style="width: 365px; height: 242px;" alt="">
                            </div>
                ...
                ?>
                    <article>
                        <a class="group" href="newdetail.php?id_post=<?php echo $post['id_post'] ?>">
                            <div class="overflow-hidden rounded-md border border-white">
                                <img class="transition duration-300 transform object-cover group-hover:opacity-80" style="width: 351px;height: 221px;" src="./assets/img/<?php echo $post['post_image'] ?>" alt="">
                            </div>
                            <div class="text-left">
