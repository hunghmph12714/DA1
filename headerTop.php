        ...
        <ul>
            <li class="inline-block pr-5 hover:text-black  group">
                <span href="./login.php" class="group">
                    ...
                    <a href="./login.php"><span class="inline-block text-base text-white group-hover:text-yellow-500 <?php
                                                                                                                        if (isset($_SESSION['user'])) {
                                                                                                                            echo 'hidden';
                                                                                                                        } else {
                                                                                                                            echo 'block';
                ...
                <div class="absolute top-0  mt-7 -ml-5  group-hover:block hidden  <?php
                    ...
                    <ul>
                        <li class="bg-white pl-5 w-40 py-1 font-bold text-black hover:text-blue-500 "><a class="" href="./changeinforuser.php?user=<?php echo $totals['username'] ?>">Quản lý
                                tài khoản</a></li>
                        ...
                        <form method="POST">
                            <li class="bg-white pl-5 w-40 py-1 font-bold text-black hover:text-blue-500 "><input type="submit" name="Logout" value="Đăng xuất" id="" class="bg-white font-bold cursor-pointer"></li>
                        </form>
